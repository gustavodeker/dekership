...
class GameConfigService:
            ...
            async with connection.cursor() as cursor:
                ...
                await cursor.execute(
                    ...
                    VALUES
                      ...
                      ('1v1_attack_range', '22'),
                      ('1v1_laser_thickness', '2.1'),
                      ('1v1_laser_length', '5.4'),
                      ('1v1_laser_gap', '7.6'),
                      ...
                      ('open_world_laser_thickness', '2.1'),
                      ('open_world_laser_length', '5.4'),
                      ('open_world_laser_gap', '7.6'),
    ...
    async def get_settings(self, mode: str = "1v1") -> dict[str, float]:
        ...
        return {
            ...
            "laser_thickness": max(0.1, float(read_setting("laser_thickness", "2.1"))),
            "laser_length": max(0.1, float(read_setting("laser_length", "5.4"))),
            "laser_gap": max(0.1, float(read_setting("laser_gap", "7.6"))),
